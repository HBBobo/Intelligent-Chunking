...
központi idegrendszerre, melynek része az
...
míg a fehérállomány pályákat tartalmaz, világos színét az idegrostok gliasejtjeinek velőshüvely (mielin) borítása adja.

A környéki (perifériás) idegrendszer részei:

agy- és gerincvelői idegek, melyek idegrostok kötegei kötőszövetes pólyával borítva.

Dúcok, melyek idegsejt csoportosulások a központi idegrendszeren kívül.

A bélcső falában húzódó neuronhálózat a bélidegrendszert (enterális) alkotja.

Érzőreceptorok, melyek lehetnek

szabad idegvégződések, pl. a fájdalomérző, ill. a hőmérsékletváltozást érzékelő receptorok (A),

kötőszövetes tokkal körülvett idegvégződések, pl. a bőr nyomásreceptorai (B),

továbbá érzékhámsejtek, pl. a belső fül szőrsejtjei (C).

Idegsejtcsoportok lehetnek:

az agyban: agyi magvak,

az agyon kívül: idegdúcok.

Idegrostok lehetnek:

a központi idegrendszerben, akkor pályákat képeznek.

Periféria felől a központ felé felszálló vagy érzőpálya (afferens pályák).

Központból a periféria felé leszálló vagy mozgatópálya (efferens pályák).

Környéki idegrendszerben, akkor idegeket alkotnak, amelyek lehetnek
...
szomatikus idegrendszerre, amely többnyire akaratlagos és vázizmokkal kapcsolatos, ill.

vegetatív (autonóm) idegrendszerre, amely többnyire akaratunktól független, simaizmokkal, mirigyekkel, szívizommal kapcsolatos. Továbbá lehet:
...
Mint korábban volt arról szó, hogy az idegsejteket nemcsak alakjuk, hanem feladatuk alapján is csoportosíthatjuk:
...
Az egész központi idegrendszert 3 burokrendszer határolja:

a kétrétegű kemény agyhártya dura mater, amelynek külső lemeze összenő a csonthártyával,

pókhálóhártya arachnoidea, mely vékony fonalakkal kapcsolódik a lágy agyhártyához,

lágy agyhártya pia mater, amely közvetlenül az agy, ill. a gerincvelő felszínéhez tapad.

A pókhálóhártya és a lágy agyhártya lemeze közötti tágasabb teret agy-gerincvelői folyadék tölti ki. Itt futnak a központi idegrendszert tápláló erek.

Az agy-gerincvelői folyadék (liquor cerebrospinalis)

Összetétele:

vérplazma szűrlet és gliasejtek váladékának keveréke (kb. 120-250 ml).

Termelődése és áramlása:

speciális érfonatok termelik, amelyek a III. és IV. agykamrákat szegélyezik.

A központi idegrendszer üregrendszerének minden részébe – agykamrák, agyburkok közti tér - eljut, állandó lassú mozgásban van.
...
Különféle kórképekben a liquor összetétele megváltozik, ill. kóros tartalom jelenik meg benne, ezért vizsgálata az idegrendszert érintő betegségek fontos diagnosztikai módszere. A mintavételt többnyire a gerinc ágyéki szakaszán végzik, a lágy agyhártya és a pókhálóhártya közötti térből. Egészséges esetben a gerincvelői folyadék tiszta, áttetsző. A liquor összetétele kórosan változik meg agyhártyagyulladás, agyvelőgyulladás, daganatos betegségek, sclerosis multiplex kórképek esetén. A spinális érzéstelenítés során pedig érzéstelenítő beadása is történhet az adott területre (nem epidurális!).

A liquor jelentősége:

benne az agy úszó testként viselkedik, a kb. 1350 g tömegű agy csak kb. 50 g súllyal nehezedik a koponyaalapra,

minden, a koponyát ért kisebb trauma következtében létrejövő lökéshullám egyenletesen terjed szét a folyadékban, ami mechanikusan védi az agyszövetet.
...
Elfolyási akadály, valamely fiziológiás szűkület helyén (aqueductus cerebri). Az akadály lehet veleszületett, ill. szerzett: gyulladás, tumor, vérzés.
...
Gerincvelői központi csatorna.

IV. agykamra a nyúltvelő-híd-kisagy szögletében,

ami felfelé a középagy területén található agykamra-csatornában folytatódik,

ezután a köztiagy ürege, a III. agykamra következik,

amelyből a féltekék oldalkamrái nyílnak (I. és II. agykamrák).

Az üregrendszert agy-gerincvelői folyadék tölti ki.

4.8.1.5. A gerincvelő

Az idegrendszer ősi része, a csigolyaívek alkotta gerinccsatornában helyezkedik el.

Kisujjnyi vastagságú, fehér, hengeres szerv, agyhártyák borítják.

Nyaki, háti, ágyéki, keresztcsonti szakaszokra osztjuk.

Kb. , az öreglyuktól kezdődően az első ágyékcsigolya magasságáig húzódik, mivel hossznövekedése nem tart lépést a gerinc növekedésével (lásd kép).
...
az izomrostokra csavarodott idegvégződés, az idegvégződéshez tartozó érzőneuron sejttestje a csigolyaközti érződúcban található (ál-egynyúlványú idegsejt).

mechanoreceptor, mivel adekvát ingere az izom megnyúlása (inakban az ínorsó van).

A reflexív lefutása

A bevezetőszárt a csigolyaközti dúcban található érzőidegsejt centrális nyúlványa képezi, mely belépve a gerincvelőbe 3 felé ágazik:
...
Az ábra forrása: Gyűjtemény a Biológia emelt szintű oktatásához